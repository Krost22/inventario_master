		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
				<label for="mod_codigo" class="col-sm-3 control-label">Proveedor</label>
				<div class="col-sm-8">
			...
			<div class="col-sm-8"> 
		    <input type="text" class="form-control" id="placa" name="placa" placeholder="Placa de Vehiculo"  maxlength="8">
			</div>
			</div>
			<div class="form-group">
